...
(function (factory, window) {
    ...
    L.Control.ZoomBar = L.Control.extend({
        ...
        onAdd: function (map) {
            let zoomBarTag = 'div';
            let zoomBarClass = 'leaflet-zoombar-control';
            let zoomBar = L.DomUtil.create(zoomBarTag, zoomBarClass);
            this._createMainDiv('', 'leaflet-control-zoombar-toggle', zoomBar, this)
            this._createZoomBtn(zoomBar, map)
